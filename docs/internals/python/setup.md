...
agent-transcripts/
  ...
  python/
    agent-transcripts/
      __init__.py            # re-exports from compiled _agent-transcripts
  tests/
...
known-first-party = ["agent-transcripts"]

[tool.ruff.format]
quote-style = "double"

[tool.pytest.ini_options]
testpaths = ["agent-transcripts", "tests"]
...
PROJECT_DIR = Path(os.environ.get("MYNEWPRODUCT_DIR", str(Path.home() / ".agent-transcripts")))
