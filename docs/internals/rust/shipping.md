...
- **Re-export the public surface from `lib.rs`.** `pub use` the handful of types/functions consumers need; keep paths shallow. Deep `agent-transcripts::internal::detail::Thing` leaking to consumers is a smell.
